...
public class ApoliceVidaService {
	...
	public Collection<ApoliceVida> obterlista(){
		
		return apoliceVidaRepository.findAll(Sort.by(Sort.Direction.DESC,"cobertura"));
	}


	public Collection<ApoliceVida> buscaTodosSegurosVidaInternacional(boolean internacional){
		return apoliceVidaRepository.findByInternacional(internacional);
	}
