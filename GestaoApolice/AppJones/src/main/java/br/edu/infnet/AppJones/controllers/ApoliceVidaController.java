...
public class ApoliceVidaController {
	...
	@GetMapping("/ApoliceVida/{condicao}/buscaInternacional")
	public Collection<ApoliceVida> buscaTodosSegurosVidaInternacional(@PathVariable("condicao") boolean internacional){
		return apoliceVidaService.buscaTodosSegurosVidaInternacional(internacional);
	}

	@GetMapping("/ApoliceVida/exibirDesc")
	public Collection<ApoliceVida> exibirDesc(){
		return apoliceVidaService.obterlista();
	}
