...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<div class="container-fluid">
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link active" href="/home">App de Gest�o de Apolice</a></li>
				<li class="nav-item"><a class="nav-link" href="/seguradora/listagem">Seguradora</a></li>
				<li class="nav-item"><a class="nav-link" href="/apolice/listagem">Ap�lice</a></li>
				<li class="nav-item"><a class="nav-link" href="/apoliceAuto/listagem">Ap�lice de Automovel</a></li>
				<li class="nav-item"><a class="nav-link" href="/apoliceVida/listagem">Ap�lice de Vida</a></li>
			</ul>
		</div>
	</nav>
	...
	<div class="container mt-3">
		...
		<span class="badge rounded-pill bg-primary">Seguradora:
			${qtdeSegurado}</span> <span class="badge rounded-pill bg-secondary">Ap�lice:
			${qtdeApolice}</span> <span class="badge rounded-pill bg-success">Ap�lice de Automovel:
			${qtdeApoliceAuto}</span> <span class="badge rounded-pill bg-danger">Ap�lice de Vida:
			${qtdeApoliceVida}</span>

		<c:if test="${not empty listagem}">
			<h2>AppVenda</h2>
			<p>Gestão de vendas de Ap�lice:</p>
			<table class="table">
