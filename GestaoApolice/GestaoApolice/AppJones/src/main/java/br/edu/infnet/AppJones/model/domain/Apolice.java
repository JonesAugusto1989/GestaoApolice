...
public abstract class Apolice {
	...
	@NotBlank(message = "É necessario preencher o campo apoliceContratante")
	...
	public String toString() {
		return "Apolice: id = " + id + "[Benificiario= " + beneficiario + ", apoliceContratante=" + apoliceContratante
